...
export default function Login() {
  ...
  return <>
    ...
    <h1 className="text-3xl text-center py-6 text-fa-bold text-green-700 mt-14">Login Now</h1>


    <form className="md:w-1/2 w-[90%]  py-10 mx-auto " onSubmit={formik.handleSubmit}>
      ...
      <div className='md:flex items-center '>
        ...
        <Link to='/forgetpassword'><p className='py-2 md:py-0 text-xl ms-4'>forget your password ?</p></Link>
      </div>
