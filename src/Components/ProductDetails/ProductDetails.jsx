  ...
  return (
    <>
      {productDetailes != null && sameCategory != null ? (
        <div className="py-10 mt-14 flex flex-wrap items-center mx-8">
          ...
          <div className="w-3/4 px-4">
            ...
            <div className="flex justify-between items-center">
              ...
              >
                <i
                  className={`${selectedProductId === productDetailes._id ? "text-main" : ""
            ...
            <div className="product cursor-pointer px-2 py-3">
              ...
              >
                ...
                <div className="flex justify-between items-center ">
                  ...
                  >
                    <i
                      className={`${selectedProductId === product._id ? "text-main" : ""
                        } fa-solid fa-2x fa-heart`}
                    ></i>
                  </Link>
                </div>
